...
const USER_FACING_OVERRIDES: Readonly<Record<string, string>> = {
  ...
  'content.label.title-lord-of-greyfen': 'Lord of Greyfen',
  'content.label.title-lord-of-northkeep': 'Lord of Northkeep',
  'content.label.title-lady-of-eastvale': 'Lady of Eastvale',
  'content.label.title-lord-of-southmere': 'Lord of Southmere',
  'content.label.title-lord-of-abbeylands': 'Lord of Abbeylands',
  'content.label.title-lady-of-westmarch': 'Lady of Westmarch',
  'content.label.territory-greyfen': 'Greyfen',
  'content.label.territory-northkeep': 'Northkeep',
  'content.label.territory-westmarch': 'Westmarch',
  'content.label.territory-eastvale': 'Eastvale',
  'content.label.territory-abbeylands': 'Abbeylands',
  'content.label.territory-southmere': 'Southmere',
  'content.label.territory-capital': 'Capital',
